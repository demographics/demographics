...
function addLegendUL(){
    ...
    content.push('<div id="filter_article"><p><div class="color yellow"></div>Photo</p></div>');
    content.push('<div id="filter_property"><p><div class="color green"></div>Article</p></div>');
    content.push('<div id="filter_photo"><p><div class="color blue"></div>Historic Event</p></div>');
